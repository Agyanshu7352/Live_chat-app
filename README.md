...
# Clerk JWT Issuer — from JWT Templates > Convex > Issuer URL
...
| `CLERK_JWT_ISSUER_DOMAIN` | Clerk Dashboard → JWT Templates → Convex → Issuer URL |
...
Built for the Tars Full Stack Engineer Internship Challenge 2026.
